...
export default function SiteLayout({ children }: { children: React.ReactNode }) {
  ...
  const staticQuickLinks: FooterLink[] = [
    ...
    { title: 'Free Trial', href: '/subscribe/7-day-free-trial' },
        ...
        <div className="footer-disclaimer">
          <div className="container">
            <p>
              ...
              <Link href="/terms-of-use">Terms and Conditions </Link>,  <Link href="/privacy-policy">Privacy Policy</Link>{' '}and{' '}
              <Link href="/financial-services-guide">Financial Service Guide</Link>{' '}for further information.
            </p>
          </div>
        </div>
